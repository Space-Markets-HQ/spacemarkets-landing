...
export default class SpaceMarketsHome extends React.Component<Props, State> {
	...
	renderVals() {
		...
		return {
			...
			openContact: () => window.open('https://www.linkedin.com/company/spacemarkets/', '_blank', 'noopener,noreferrer'),
			...
			menuRequestAccess: () => {
				document.body.style.overflow = '';
				this.setState({menuOpen: false});
				window.open('https://www.linkedin.com/company/spacemarkets/', '_blank', 'noopener,noreferrer');
			},
			menuLinks: [
				...
				{v.menuOpen && (
					...
					>
						...
						<div style={{marginTop: 'auto', padding: '0 20px calc(24px + env(safe-area-inset-bottom))'}}>
							...
							<a
								href='https://www.linkedin.com/company/spacemarkets/'
								target='_blank'
								rel='noopener noreferrer'
								className='sm-hover-light'
								style={{
							...
							>
								...
								Follow Space Markets on LinkedIn
							</a>
						</div>
					</div>
				)}
